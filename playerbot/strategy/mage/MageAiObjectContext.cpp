    ...
    namespace mage
    {
        ...
        public:
            TriggerFactoryInternal()
            {
                ...
                creators["fire spells on cooldown"] = &TriggerFactoryInternal::fire_spells_on_cooldown;
#ifdef MANGOSBOT_TWO
        ...
        private:
            ...
            static Trigger* fire_spells_on_cooldown(PlayerbotAI* ai) { return new FireSpellsOnCooldown(ai); }
#ifdef MANGOSBOT_TWO
